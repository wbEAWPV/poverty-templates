...
//  d. democratic mean of cost per calorie
collapse (mean) cost_per_cal, by(hhid hhweight) // collapse by hh first
mean cost_per_cal [aw = hhweight]

//  e. set food poverty line based on target number of calories per day
